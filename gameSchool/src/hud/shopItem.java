...
public class shopItem implements Renderable {
	 ...
	 *            mal werden)
	 * @param uc
	 *            Upgrade Cost (Basis-upgradekosten (Kosten f�r 1. Upgrade))
	 * @param di
	 ...
	 * @param itemspace
	 *            Position und Groe�e des Shopfensters f�r die einzelne Figur
	 *            (=Kaufbutton)
	 * @param upgradespace
	 *            Position und Groe�e des Upgardebuttons fuer die Figur
	 * @param paint
